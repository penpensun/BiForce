 ...
 */
public class BipartiteGraph_deprecated{
    ...
    public BipartiteGraph_deprecated(BipartiteGraph_deprecated k)
    {
     ...
     * Needs Test
     */
    public BipartiteGraph_deprecated(String InputFile) throws IOException
    {
        read(InputFile);
     ...
     * @param EdgeWeights 
     */
    public BipartiteGraph_deprecated(double[][] EdgeWeights)
    {
        //init vertices
     ...
     * @param ColNames 
     */
    public BipartiteGraph_deprecated(double[][] EdgeWeights, ArrayList<String> RowNames, ArrayList<String> ColNames) 
    {
         //first assign the EdgeWeights in this class to the given EdgeWeights
        this.edgeWeights = EdgeWeights;
        //then create vertices for rows
